...
class GoAwayPlayer:
    def __init__(self, wav_path):
        ...
        self._thread = None
        self._play_count = 3  # 默认播放3次

    def _play_n_times(self):
        for _ in range(self._play_count):
    ...
    def start(self, n=3):
        ...
        self._thread = threading.Thread(target=self._play_n_times, daemon=True)
        self._thread.start()
    ...
    def image_callback(self, msg):
        with self._lock:
            ...
            try:
                ...
                abnormal_keywords = ['Abnormal','trash']
